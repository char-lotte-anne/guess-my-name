...
class EnhancedNameDatabase {
    ...
    initializeNameDefinitions() {
        // Name definitions database - positive, neutral definitions from reputable etymological sources
        // All definitions are positive and avoid gender/race stereotypes
        this.nameDefinitions = {
            // Common names A-C
            ...
            'donald': 'World ruler, proud leader',
            'donna': 'Lady, woman',
            'dorothy': 'Gift of God',
            ...
            // Popular names from 2024 - Female names
            'aaliyah': 'Exalted, sublime',
            'abigail': 'Father\'s joy',
            'ada': 'Noble, prosperous',
            'adalyn': 'Noble, kind',
            'adalynn': 'Noble, kind',
            'addison': 'Son of Adam',
            'adelaide': 'Noble, kind',
            ...
            'adelyn': 'Noble, kind',
            'adelynn': 'Noble, kind',
            'adriana': 'From Hadria, darkness',
            'ailani': 'True leader',
            'ailany': 'True leader',
            'alaia': 'Joyful, happy',
            'alaina': 'Precious, awakening',
            'alana': 'Precious, awakening',
            'alani': 'Orange tree',
            'alanna': 'Precious, awakening',
            'alaya': 'Exalted, sublime',
            'alayah': 'Exalted, sublime',
            'alayna': 'Precious, awakening',
            'alessandra': 'Defender of people',
            'alessia': 'Defender, helper',
            'alexandria': 'Defender of people',
            'alicia': 'Noble, exalted',
            'alina': 'Bright, beautiful',
            'alison': 'Noble, exalted',
            'alivia': 'Olive tree',
            'aliyah': 'Exalted, sublime',
            ...
            'aniyah': 'Caring, compassionate',
            'angela': 'Messenger, angel',
            'annabelle': 'Grace, favor',
            'annalise': 'Grace, favor',
            ...
            'elora': 'Light',
            'elowyn': 'Elm tree',
            'emely': 'Industrious, striving',
            'emerson': 'Son of Emery',
            'emersyn': 'Son of Emery',
            'emery': 'Industrious leader',
            'emmy': 'Industrious, striving',
            'emory': 'Industrious leader',
            'esme': 'Esteemed, beloved',
            'esmeralda': 'Emerald',
            'evelynn': 'Desired, wished for',
            'everlee': 'Wild boar meadow',
            'everleigh': 'Wild boar meadow',
            'evie': 'Life, living',
            'fatima': 'Captivating, weaning',
            'felicity': 'Happiness, good fortune',
            'fernanda': 'Adventurous, bold',
            'finley': 'Fair warrior',
            'fiona': 'Fair, white',
            'florence': 'Flowering, prosperous',
            ...
            'kennedy': 'Helmeted leader',
            'kenzie': 'Fair one',
            'khloe': 'Young green shoot',
            'kiara': 'Bright, clear',
            'kiera': 'Noble, darkness',
            'kinsley': 'King\'s meadow',
            'kira': 'Light, beam',
            'kyla': 'Narrow, straight',
            'kylee': 'Narrow, straight',
            'kylie': 'Boomerang',
            'laila': 'Night, beauty',
            'lana': 'Light, rock',
            'lani': 'Sky, heaven',
            ...
            'londyn': 'From London',
            'londynn': 'From London',
            'lucia': 'Light, illumination',
            'luciana': 'Light, illumination',
            'lucille': 'Light, illumination',
            'lucy': 'Light, illumination',
            'luna': 'Moon',
            'lydia': 'From Lydia',
            'lyla': 'Night, beauty',
            ...
            'maia': 'Great, mother',
            'makenna': 'Happy one',
            'makenzie': 'Son of Kenneth',
            'malia': 'Bitter, wished-for child',
            'margot': 'Pearl, precious',
            'mariana': 'Star of the sea',
            'marianna': 'Star of the sea',
            'marie': 'Star of the sea',
            'marisol': 'Sea and sun',
            'maya': 'Water, illusion',
            'mckenna': 'Son of Kenneth',
            'mckenzie': 'Son of Kenneth',
            'melanie': 'Darkness',
            'melody': 'Song, music',
            'mia': 'Mine, beloved',
            'mila': 'Gracious, dear',
            'millie': 'Industrious, striving',
            'mira': 'Wonder, peace',
            'miriam': 'Bitter, wished-for child',
            'molly': 'Bitter, wished-for child',
            'monica': 'Advisor, alone',
            'morgan': 'Sea circle',
            'myra': 'Wonder, peace',
            'myla': 'Gracious, dear',
            ...
            'skylar': 'Scholar, shelter',
            'skyler': 'Scholar, shelter',
            'sloane': 'Warrior, raider',
            'sofia': 'Wisdom, knowledge',
            'sophia': 'Wisdom, knowledge',
            'sophie': 'Wisdom, knowledge',
            'stella': 'Star',
            ...
            'tori': 'Victory, conqueror',
            'trinity': 'Three, unity',
            'valentina': 'Strong, valiant',
            ...
            // Popular names from 2024 - Male names
            ...
            'eliot': 'Yahweh is God',
            'elliott': 'Yahweh is God',
            'enzo': 'Winner, conqueror',
            'eric': 'Eternal ruler',
            'ethan': 'Strong, firm',
            'ezra': 'Help, helper',
            'felix': 'Happy, fortunate',
            'finn': 'Fair, white',
            'finnley': 'Fair warrior',
            'fletcher': 'Arrow maker',
            'ford': 'River crossing',
            'francisco': 'Free person',
            'gabriel': 'God is my strength',
            'gael': 'Gaelic, Irish',
            'gavin': 'White hawk',
            'george': 'Farmer, earthworker',
            ...
            'lincoln': 'Lake colony',
            'logan': 'Little hollow',
            'luca': 'Light, illumination',
            'lucas': 'Light, illumination',
            'luis': 'Famous warrior',
            'luke': 'Light, illumination',
            'maddox': 'Son of Madoc',
            'marcus': 'Warlike',
            'mason': 'Stone worker',
            'mateo': 'Gift of God',
            ...
            'oscar': 'God spear, deer friend',
            'owen': 'Young warrior, noble',
            'parker': 'Park keeper',
            'patrick': 'Nobleman, patrician',
            'paul': 'Small, humble',
            'peter': 'Rock, stone',
            'phoenix': 'Dark red, mythical bird',
            'preston': 'Priest\'s town',
            'quinn': 'Wisdom, reason',
            'rafael': 'God has healed',
            'raiden': 'God spirit, thunder',
            'reid': 'Red-haired',
            'remington': 'Raven family estate',
